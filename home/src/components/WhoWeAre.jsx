...
function WhoWeAre() {
  const members = [
    ...
    { image: '/static/team/eacosta.png', nameKey: 'whoWeAre.member12.name', nameDefault: 'Ernesto Acosta', roleKey: 'whoWeAre.member12.role', roleDefault: 'Responsable de dirección de arte' },
