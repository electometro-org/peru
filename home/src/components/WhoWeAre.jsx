...
function WhoWeAre() {
  const members = [
    ...
    { image: '/static/team/dabanto.jpeg', nameKey: 'whoWeAre.member11.name', nameDefault: 'Daniel Abanto', roleKey: 'whoWeAre.member11.role', roleDefault: 'Analista de datos' },
    { image: '/static/team/mgalvez.jpeg', nameKey: 'whoWeAre.member13.name', nameDefault: 'Mariana Gálvez', roleKey: 'whoWeAre.member13.role', roleDefault: 'Imagen pública' },
    { image: '/static/team/acereceda.jpeg', nameKey: 'whoWeAre.member14.name', nameDefault: 'Ángel Cereceda', roleKey: 'whoWeAre.member14.role', roleDefault: 'Creador de contenido en redes sociales e imagen pública' },
  ]
